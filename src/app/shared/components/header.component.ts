    ...
    template: `
        <header class="max-w-5xl mx-auto flex justify-between items-center mb-12">
            ...
            <div class="flex items-center gap-3 cursor-pointer group"
                ...
                <img src="assets/logo.svg" alt="Bam! logo"
                     class="w-10 h-10 shadow-lg shadow-bam-primary/20 group-hover:shadow-xl group-hover:shadow-orange-500/30 transition-all">
